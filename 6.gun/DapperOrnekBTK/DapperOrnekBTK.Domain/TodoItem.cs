namespace DapperOrnekBTK.Domain
{
    public class TodoItem
    {
        ...
        private void SetTitle(string title)
        {
            ...
            {
                throw new ArgumentNullException($"{nameof(Title)} boş geçilemez.");
            }
        ...
        private void SetDescription(string description)
        {
            ...
            {
                throw new ArgumentNullException($"{nameof(Description)} boş geçilemez.");
            }
